...
<head>
    ...
    <title>Codul tau pentru schimbarea emailului</title>
    <style>
...
<body>
    <div class="wrapper">
        ...
        <div class="body">
            ...
            <p class="description">
                Ai solicitat schimbarea adresei de email a contului tău de pe
                <strong style="color:#e5e5ea">NMA Academy</strong>.
                Folosește codul de mai jos pentru a confirma noua adresă de email.
            </p>
            ...
            <p class="disclaimer">
                Dacă nu ai solicitat schimbarea adresei de email, poți ignora acest email.
                Adresa ta curentă rămâne activă și contul rămâne protejat.
                Dacă crezi că cineva încearcă să acceseze contul tău, contactează suportul imediat.
            </p>
        </div>
        <div class="footer">
