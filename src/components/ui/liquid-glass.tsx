...
const springGlassTiming = "cubic-bezier(0.175, 0.885, 0.32, 2.2)";
...
const GlassEffect: React.FC<GlassEffectProps> = ({
  ...
  const glassStyle = {
    ...
    transitionTimingFunction: springGlassTiming,
    ...style,
  };
  ...
  const content = (
    <div
      className={cn(
        "relative flex font-semibold overflow-visible text-black cursor-pointer transition-all duration-700",
        className,
      )}
      style={glassStyle}
    >
